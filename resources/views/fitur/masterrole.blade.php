...
<div class="content-wrapper" style="min-height: 278px;">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="float-sm-right">
                                <button type="button" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#modal-add-role"><i class="fa fa-plus" aria-hidden="true"></i>Add Role</button>
                            </div>
                        </div>
    ...
    <div id="modal-add-role" class="modal fade show" aria-modal="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="form" name="form" action="{{ route('role-insert') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-check-label" for="roleid">Role Id:</label>
                            <input type="text" name="roleid" class="form-control" id="roleid" maxlength="5">
                        </div>
                        <div class="form-group">
...
<script>
    ...
    $('#m-role').addClass('active');
    $('#m-role').parent().parent().parent().addClass('menu-is-opening menu-open');
</script>
<script>
    $(function () {    
        ...
        $(document).on('click', '.delete', function () {
            $('#delete-role-id').val($(this).attr("data-roleid"));
